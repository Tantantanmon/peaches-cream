...
.pc-tb-tag{padding:4px 10px;border-radius:20px;font-size:12px;font-weight:500;background:#f4f4f4;color:#444;cursor:pointer;border:0.5px solid #e8e8e8;transition:all .1s;user-select:none;display:inline-block;}
.pc-tb-tag:hover{background:#eee;}
.pc-tb-tag.active{background:#1a1a1a;color:#fff;border-color:#1a1a1a;}
.pc-tb-add{padding:4px 10px;border-radius:20px;font-size:12px;background:transparent;color:#ccc;border:0.5px dashed #ddd;cursor:pointer;display:inline-block;}
