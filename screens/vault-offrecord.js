...
export async function render() {
  ...
  // 탭바를 scroll-area 안에 넣어서 화면 전환 시 자동 제거
  area.innerHTML = `
...
- comment: 2-4 line Korean comment in ${charName}'s voice (inner monologue, slightly defensive, mix of denial and admission). NO female-degrading slurs.`;
    } else {
...
- comment: 2-4 line Korean comment in ${charName}'s exact voice. Explicit, unapologetic. NO female-degrading slurs.`;
    }
