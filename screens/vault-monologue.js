...
Return ONLY a JSON object (no markdown):
{
  ...
  "mono": "EXACTLY 4 lines of inner monologue in Korean. Around 50 words total. ${charReaction} Each line separated by \\n."
}`;
...
function renderAll() {
  ...
  if (!card || !card.generated) {
    ...
    html += `
      <div class="ml-card" id="ml-main-card">
        <div class="ml-q">${esc(card.q.qKr)}</div>
        <div class="ml-dialogue-wrap">
