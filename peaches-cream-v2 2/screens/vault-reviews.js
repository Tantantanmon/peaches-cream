// screens/vault-reviews.js — Reviews
...
- tags: array of 3-4 tag objects {t: string, g: boolean} — good/bad aspects
- reason: {rec: boolean, text: 2 sentence reason for rec/norec}
Make reviews varied in sentiment (mix of positive, negative, mixed). Reflect ${charName}'s actual personality and behaviors.`;

    const result = await generate(sys, '후기 5개 생성해줘');
    let reviews = [];
