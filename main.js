...
const SCREENS = {
  'home':           () => import('./home.js').then(m => m.render()),
  'profile':        () => import('./profile.js').then(m => m.render()),
  'redflag':        () => import('./redflag.js').then(m => m.render()),
  'clinic':         () => import('./clinic.js').then(m => m.render()),
  'vault':          () => import('./vault.js').then(m => m.render()),
  'vault-reviews':  () => import('./vault-reviews.js').then(m => m.render()),
  'vault-offrecord':() => import('./vault-offrecord.js').then(m => m.render()),
  'vault-fanfeed':  () => import('./vault-fanfeed.js').then(m => m.render()),
  'vault-settings': () => import('./vault-settings.js').then(m => m.render()),
  'vault-dreamlog': () => import('./vault-dreamlog.js').then(m => m.render()),
  'vault-monologue':() => import('./vault-monologue.js').then(m => m.render()),
};
...
function getWorldInfo() {
  if (window.parent && window.parent.__PC_WORLD_INFO__) return window.parent.__PC_WORLD_INFO__;
  return worldInfo || '';
}
